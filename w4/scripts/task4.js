...
// Step 4: Add another property named favoriteFoods with a value of an array of your favorite 
// foods as strings ( hint: [] )
...
// Step 7: Inside of the empty array above, add a new object with two properties: place and length and 
...
myInfo.placesLived = [
{
    place: 'Barranquilla, Atlantico, Colombia.',
    length: '26 Last years'
},
{
    place: 'Sevilla, Magdalena, Colombia',
    length: '9 years'
},
{
    place: 'Fundacion, Magdalena, Colombia',
    length: '1 years'
}
]
...
// Step 1: Assign the value of the name property (of the object declared above) to the HTML <span> element
//  with an ID of name
...
// Step 4: For each favorite food in the favoriteFoods property, create an HTML <li> element and 
// place its value in the <li> element
